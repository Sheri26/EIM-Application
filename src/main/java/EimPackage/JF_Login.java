...
public class JF_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnl_Login, javax.swing.GroupLayout.DEFAULT_SIZE, 718, Short.MAX_VALUE)
        );
    ...
    private void btn_LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_LoginActionPerformed
        ...
        EimPackage.DAOPackage.EmployeeDAO emp = new EimPackage.DAOPackage.EmployeeDAO();
        ...
        if (username.isEmpty() || password.isEmpty() || username.isBlank() || password.isBlank()){
            ...
            btn_Login.setEnabled(false);
            new EimPackage.JF_Manager_Home().setVisible(true);
            //new com.sherrydev.eimSystem.EimsPackage.JF_Login().dispose();
        }
